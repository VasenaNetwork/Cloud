...
public class PluginLoader {
    ...
    protected PluginYAML loadPluginData( File file, Yaml yaml ) {
        try ( JarFile pluginJar = new JarFile( file ) ) {
            ...
            if ( configEntry == null ) {
                ...
                while ( entries.hasMoreElements() ) {
                    ...
                    if ( entry.getName().endsWith( ".class" ) ) {
                        ...
                        if ( classReader.getSuperName().equals( "com/bedrockcloud/bedrockcloud/api/plugin/Plugin" ) ) {
                            ...
                            classReader.accept( new ClassVisitor( Opcodes.ASM7 ) {
                                ...
                                public AnnotationVisitor visitAnnotation( String descriptor, boolean visible ) {
                                    switch ( descriptor ) {
                                        case "Lcom/bedrockcloud/bedrockcloud/api/plugin/annotation/PluginName;" -> {
                                        ...
                                        case "Lcom/bedrockcloud/bedrockcloud/api/plugin/annotation/Version;" -> {
                                            return new AnnotationVisitor(Opcodes.ASM7) {
                                                @Override
                                                public void visit(String key, Object value) {
                                        ...
                                        case "Lcom/bedrockcloud/bedrockcloud/api/plugin/annotation/Author;" -> {
                                            return new AnnotationVisitor(Opcodes.ASM7) {
                                                @Override
                                                public void visit(String key, Object value) {
                                        ...
                                        case "Lcom/bedrockcloud/bedrockcloud/api/plugin/annotation/Depends;" -> {
                                            return new AnnotationVisitor(Opcodes.ASM7) {
                                                @Override
                ...
                this.logger.warning( "Jar file " + file.getName() + " doesnt contain a plugin.yml!" );
                return null;
            }
            ...
            this.logger.warning( "Invalid plugin.yml for " + file.getName() + ": main and/or name property missing" );
        } catch ( IOException e ) {
